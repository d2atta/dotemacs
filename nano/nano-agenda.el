...
(define-minor-mode nano-agenda-mode
  ...
  :init nil
  :keymap `((,(kbd "h")    . nano-agenda-backward-day)
            (,(kbd "l")   . nano-agenda-forward-day)
            (,(kbd "k")      . nano-agenda-backward-week)
            (,(kbd "j")    . nano-agenda-forward-week)
...
+--------------------------+    +--------------------------+"
  ...
  (let* ((agenda-buffer "*nano-agenda*")
    ...
    (or agenda-window (split-window nil -12 'below))))
